...
ROTATION = [
    ...
    # ─── Erweiterung 03.09.2026: neue Branchen/Städte für frischen Lead-Pool ──
    ("Dachdecker", "Berlin Neukölln"),
    ("Dachdecker", "Potsdam"),
    ("Dachdecker", "Cottbus"),
    ("Bäckerei", "Berlin Mitte"),
    ("Bäckerei", "Potsdam"),
    ("Sanitär", "Berlin Mitte"),
    ("Sanitär", "Potsdam"),
    ("Elektriker", "Frankfurt Oder"),
    ("Maler", "Potsdam"),
    ("Maler", "Frankfurt Oder"),
    ("Gartenbau", "Frankfurt Oder"),
    ("Tischlerei", "Potsdam"),
    ("Tischlerei", "Frankfurt Oder"),
    ("Kosmetik", "Frankfurt Oder"),
    ("Friseur", "Frankfurt Oder"),
    ("Reinigung", "Potsdam"),
    ("Fahrschule", "Potsdam"),
    ("Zahnarzt", "Frankfurt Oder"),
    ("Physiotherapie", "Frankfurt Oder"),
    ("Optiker", "Frankfurt Oder"),
    ("Schlüsseldienst", "Cottbus"),
    ("Schlüsseldienst", "Frankfurt Oder"),
    ("Metzgerei", "Potsdam"),
    ("Metzgerei", "Frankfurt Oder"),
    ("Kfz Werkstatt", "Potsdam"),
    ("Kfz Werkstatt", "Frankfurt Oder"),
]
